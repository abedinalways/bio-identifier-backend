...
async function main() {
    ...
    const snakesData = [
        {
            ...
            isVenomous: true,
            dangerLevel: client_1.DangerLevel.deadly,
            venomCategory: client_1.VenomCategory.hemotoxic,
            ...
            lethalityRisk: 'Extremely Critical - Leading cause of snakebite fatalities and kidney necrosis across South Asia',
            habitat: 'Agricultural open fields, paddy fields, tall grasses, rodent burrows near rural settlements.',
            distribution: [
            ...
            ecologicalImportance: 'Controls agricultural rodent populations that destroy food grains.',
        },
        {
            id: 'spectacled-cobra',
            ...
            isVenomous: true,
            dangerLevel: client_1.DangerLevel.deadly,
            venomCategory: client_1.VenomCategory.neurotoxic,
            antivenomRequired: true,
            antivenomType: 'Polyvalent Anti-Snake Venom (ASV) Serum',
            commercialBrands: [
                'Incepta Antivenom',
            ...
            lethalityRisk: 'Critical - Can induce complete respiratory failure within 30 to 120 minutes without antivenom.',
            habitat: 'Agricultural fields, grain storage bins, old brick piles, abandoned termite mounds.',
            distribution: [
            ...
            ecologicalImportance: 'Apex reptile predator keeping rat and rodent pests in check.',
        },
        {
            id: 'common-krait',
            ...
            lethalityRisk: 'Extremely Lethal - Bite is painless with almost no swelling, often occurring while victims sleep on ground mats.',
            habitat: 'Rural huts, thatched roof huts, mud houses, rat holes near kitchens and beds.',
            ...
            ecologicalImportance: 'Ophiophagous (eats other snakes, maintaining balanced reptile populations).',
        },
        {
            ...
            isVenomous: false,
            dangerLevel: client_1.DangerLevel.harmless,
            venomCategory: client_1.VenomCategory.non_venomous,
            antivenomRequired: false,
            antivenomType: 'None (Safe)',
            commercialBrands: [],
            targetToxins: [],
            lethalityRisk: 'Completely Non-Venomous - Poses zero toxic danger to humans.',
            ...
            ecologicalImportance: "THE FARMER'S BEST FRIEND. A single adult rat snake consumes over 20-30 destructive field rats every month!",
        },
        {
            ...
            commercialBrands: [],
            targetToxins: [],
            lethalityRisk: 'Non-Venomous - Highly aggressive flattener when cornered, but completely non-toxic.',
            ...
            ecologicalImportance: 'Controls invasive small fish, tadpole, and aquatic insect populations in agricultural waterways.',
        },
        {
            id: 'monocled-cobra',
            ...
            lethalityRisk: 'Extremely Critical - Rapid neurological deterioration and respiratory paralysis within 60 minutes.',
            ...
            ecologicalImportance: 'Crucial predator controlling destructive rodent populations near human settlements.',
        },
        {
            id: 'banded-krait',
            ...
            lethalityRisk: 'Extremely Dangerous - Neurotoxic paralysis, though less aggressive by day than common krait.',
            ...
            imageUrl: 'https://images.unsplash.com/photo-1583852085732-b0a68894df55?auto=format&fit=crop&w=800&q=80',
            firstAidSteps: [
            ...
            ecologicalImportance: 'Ophiophagous - naturally hunts other venomous snakes like cobras and kraits.',
        },
        {
            ...
            commercialBrands: [],
            targetToxins: [],
            lethalityRisk: 'Completely Harmless - Often mistakenly killed because its crossbands mimic the deadly Common Krait.',
            ...
            ecologicalImportance: 'Controls household lizards, mice, and indoor pests inside villages.',
        },
        {
            id: 'green-vine-snake',
            ...
            isVenomous: true,
            dangerLevel: client_1.DangerLevel.mild,
            venomCategory: client_1.VenomCategory.cytotoxic,
            antivenomRequired: false,
            antivenomType: 'None (Mild / Non-lethal to humans)',
            commercialBrands: [],
            targetToxins: ['Mild rear-fanged salivary secretions'],
            lethalityRisk: 'Mild - Causes minor local swelling or numbness for a few hours. Poses zero lethal threat to humans.',
            ...
            ecologicalImportance: 'Keeps orchard insects, tree frogs, and garden lizards in ecological balance.',
        },
    ];
    ...
    const pestsData = [
        {
            ...
            category: client_1.PestCategory.crop_pest,
            commonNames: {
            ...
            affectedCrops: ['mango'],
            severity: client_1.PestSeverity.critical,
            symptoms: [
            ...
            damageMechanism: 'Sap depletion during flowering season prevents fruit set, causing up to 60-80% yield loss.',
            yieldLossPotential: '50% - 80% loss in untreated orchards during flowering (January-March)',
            stingRemedy: null,
            imageUrl: 'https://images.unsplash.com/photo-1521747116042-5a810fda9664?auto=format&fit=crop&w=800&q=80',
            treatments: [
                {
                    id: 'mh-bio',
                    type: client_1.TreatmentType.organic,
                    ...
                    optimalTiming: 'Spray at initial panicle emergence before flowers fully open.',
                    preHarvestIntervalDays: 3,
                    safetyInstructions: 'Safe for honeybees when sprayed after sunset. Natural biodegradable deterrent.',
                },
                {
                    id: 'mh-chem',
                    type: client_1.TreatmentType.chemical,
                    ...
                    optimalTiming: 'Single spray at bud burst stage. Do NOT spray during full bloom to safeguard pollinators.',
                    preHarvestIntervalDays: 21,
                    safetyInstructions: 'Toxic to bees. Wear full protective gloves, mask, and spray in early morning calm wind.',
                },
            ],
        },
        {
            ...
            damageMechanism: 'Tunneling near seed stalk destroys nutrient supply to aril and exposes pulp to fungal decay.',
            ...
            treatments: [
                ...
                },
                {
                    ...
                    optimalTiming: 'Apply when fruits reach pea size, repeated 15 days later.',
                    preHarvestIntervalDays: 14,
                    safetyInstructions: 'Must stop spraying at least 14 days before harvest. Wear respirator.',
                },
            ],
        },
        {
            ...
            damageMechanism: 'Destruction of internal vascular tissues prevents grain filling.',
            ...
            treatments: [
                {
                    ...
                    optimalTiming: 'Install perches immediately after seedling transplanting.',
                    preHarvestIntervalDays: 0,
                    safetyInstructions: 'Eco-friendly, attracts drongos and swallows that feast on adult moths.',
                },
                {
                    id: 'rsb-chem',
                    type: client_1.TreatmentType.chemical,
                    ...
                    optimalTiming: 'Apply when egg masses exceed 1 per square meter or 5% deadhearts noticed.',
                    preHarvestIntervalDays: 21,
                    safetyInstructions: 'Ensure water level in paddy field is 2-3 inches. Do not release drainage into fish ponds.',
                },
            ],
        },
        {
            ...
            category: client_1.PestCategory.stinging_insect,
            commonNames: {
            ...
            damageMechanism: 'Venom contains mastoparan peptide and phospholipase triggering histamine storm and cytolysis.',
            yieldLossPotential: 'Also decimates honeybee hives and damages ripe fruit crops before harvest.',
            stingRemedy: 'Apply ice pack immediately. Elevate the area. If patient experiences breathlessness, throat tightness, or dizziness, rush to emergency for adrenaline/epinephrine immediately.',
            imageUrl: 'https://images.unsplash.com/photo-1590452237887-8820c5ba53ae?auto=format&fit=crop&w=800&q=80',
            treatments: [
                {
                    id: 'agh-trap',
                    type: client_1.TreatmentType.organic,
        ...
        },
        {
            ...
            affectedCrops: ['rice'],
            severity: client_1.PestSeverity.moderate,
            symptoms: [
            ...
            damageMechanism: 'Cardiotoxic peptide toxins acting on voltage-gated potassium and sodium channels.',
            yieldLossPotential: 'Accidental human bites in rural huts, straw piles, and firewood stacks.',
            stingRemedy: 'Immerse bite in hot water (40-45°C / comfortably bearable) for 20-30 mins to denature heat-labile venom proteins. Take pain relievers and apply antiseptic.',
            imageUrl: 'https://images.unsplash.com/photo-1582845512747-e42001c95638?auto=format&fit=crop&w=800&q=80',
            treatments: [
                {
                    id: 'gc-barrier',
                    type: client_1.TreatmentType.organic,
        ...
        },
        {
            ...
            damageMechanism: 'Rapid larval chewing strips vegetative canopy, destroying photosynthetic capability.',
        ...
        },
        {
            ...
            damageMechanism: 'Continuous sap sucking dries out plant moisture and transmits viral plant diseases.',
    ...
    console.log(`✅ Seeded ${pestsData.length} pest & stinging insect profiles with treatments.`);
    const hospitalsData = [
        {
            id: 'dhaka-dmch',
    ...
    console.log(`✅ Seeded ${hospitalsData.length} emergency antivenom hospitals.`);
