...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get current user profile and recent diagnoses' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update current user personal profile' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'List all registered users (Admin only)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Update user authorization role (Admin only)' }),
